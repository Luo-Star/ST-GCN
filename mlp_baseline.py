...
if __name__ == '__main__':
    train_data = np.load('second_data/30TR20/train_data.npy')
    train_label = np.load('second_data/30TR20/train_label.npy')
    test_data = np.load('second_data/30TR20/val_data.npy')
    test_label = np.load('second_data/30TR20/val_label.npy')
